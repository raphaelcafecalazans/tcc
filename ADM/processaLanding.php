...
if(($busca) AND ($busca -> num_rows != 0)){
	if(($buscaid) AND ($buscaid -> num_rows != 0)) {
		$query1 = "UPDATE `tbl_subcliente` SET `Nome_SubCliente`='$nome',`Receber`='$receber' WHERE Email_SubCliente = '".$email."'";
		...
		$query2 ="INSERT INTO `tbl_subcliente`(`Email_SubCliente`, `Nome_SubCliente`, `Id_evento`, `Receber`, `DataSub`, `Id_cliente`) VALUES ('$email','$nome','$id','$receber','$data','".$_SESSION['idC']."')";
	...
	$query3 ="INSERT INTO `tbl_subcliente`(`Email_SubCliente`, `Nome_SubCliente`, `Id_evento`, `Receber`, `DataSub`, `Id_cliente`) VALUES ('$email','$nome','$id','$receber','$data','".$_SESSION['idC']."')";
